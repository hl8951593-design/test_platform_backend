...
QUERY_PROJECT_CASES_MODEL_MESSAGE_MAX_CHARS = 5000
...
class ToolResultPolicy:
    ...
    def model_output_view(self, output: Any, *, tool_name: str | None = None) -> dict[str, Any]:
        projection = ToolResultProjectionService().project(tool_name, output)
        if projection is not None:
            return {
                "output": projection.model_output,
                "preview": None,
                "truncated": False,
                "size_chars": projection.full_output_size_chars,
