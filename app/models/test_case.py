...
class TestCaseExecution(Base):
    ...
    trigger_source: Mapped[str] = mapped_column(String(32), nullable=False, default="manual", server_default="manual", comment="触发来源")
    agent_run_id: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="关联 Agent Run")
    agent_tool_call_id: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="关联 Agent ToolCall")
    trigger_tool_name: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="触发工具名")
