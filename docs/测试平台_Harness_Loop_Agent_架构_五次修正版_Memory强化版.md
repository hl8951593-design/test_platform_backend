...
dispatch_trace_summary_fields=dispatch_trace_version_hash,dispatch_trace_hash,tool_call_id,run_id,runtime_snapshot_id,tool_name,tool_version,schema_hash,manifest_hash,router,runtime,backend_handler,backend_name,backend_operation,backend_contract_version,resolved_side_effect_class,resolved_replay_policy,status,effect_submission_state
